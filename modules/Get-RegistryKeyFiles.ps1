Write-Host "[*] Gathering Registry Key File Entries..." -ForegroundColor DarkYellow
Write-Host "    [-] Fetching UserSettings Entries..." -ForegroundColor DarkYellow
...
Write-Host "    [-] Fetching Compatibility Assistant Entries..." -ForegroundColor DarkYellow
...
Write-Host "    [-] Fetching AppsSwitched Entries..." -ForegroundColor DarkYellow
...
Write-Host "    [-] Fetching MuiCache Entries..." -ForegroundColor DarkYellow
